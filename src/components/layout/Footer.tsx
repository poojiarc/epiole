        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-2 md:col-span-2">
            <Link to="/" className="flex items-center gap-3 mb-4">
              ...
              />
              <div className="flex flex-col">
                <span className="brand-name brand-name-main text-xl leading-tight">
                  EPIOLE
                </span>
                <span className="brand-name brand-name-sub text-[0.65rem] opacity-70 leading-tight">
                  TRANSDERMIC
                </span>
              </div>
            </Link>

            <p className="text-sm opacity-70 leading-relaxed max-w-md text-justified">
              Premium derma-pharmaceutical solutions backed by science. We combine
              cutting-edge transdermal technology with clinically proven
              ingredients to deliver skincare that truly works.
            </p>
          </div>
              ...
              {quickLinks.map((link) => {
                ...
                return (
                  <Link
                    ...
                    className="flex items-center gap-2 text-sm opacity-70 hover:opacity-100 transition-colors"
                  >
                    <Icon className="w-4 h-4" />
                    {link.name}
                  </Link>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 text-sm opacity-70 hover:opacity-100 transition-colors group"
                  >
